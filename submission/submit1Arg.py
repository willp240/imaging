...
def pycondor_submit(exe_name, base_name, arg, job_name, img_dir, input_file, over_dir, sleep_time = 1, priority = 5):
    '''
    ...
    out_macro_text = "#!/usr/bin/sh  \n" + \
                     ...
                     str(exec_path) + " " + os.path.abspath(input_file) + " " + os.path.abspath(over_dir) + "/" + str(job_name) + ".root " + str(arg) + "  \n"                     
...
if __name__ == "__main__":
    ...
    parser.add_argument('argument', type=float, help='argument to the exec')
    ...
    arg = args.argument
    base_name = args.outputname + "_" + str(arg)
    ...
    pycondor_submit(exe_name, base_name, arg, job_id, img_dir, input_file, over_dir, sleep_time = 1, priority = 5)
